...
struct ShaderParameterCollector
{
	...
	{
		return Mode == FixedShaderType::AdvancedUnlit ||
			   Mode == FixedShaderType::AdvancedLit ||
			   Mode == FixedShaderType::AdvancedBackDistortion;
	}
